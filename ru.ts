export const RU = {
    ...
    LumberMill: "Фабрика лесоматериала",
    Lumber: "Лесоматериал",
    Paper: "Бумага",
    PaperMill: "Фабрика бумаги",
    Book: "Книга",
    ...
    SellBuilding: "Продать сооружение",
    ...
    Silicon: "Силикон",
    AluminumMine: "Шахта алюминия",
    CopperMine: "Шахта меди",
    SiliconMine: "Silicon Mine",
    IronMine: "Шахта железа",
    CoalMine: "Шахта угля",
    ...
    WebBrowser: "Браузер",
    Console: "Консоль",
    ConsoleFactory: "Завод консолей",
    Train: "Поезд",
    TrainFactory: "Завод поездов",
    ShoeFactory: "Фабрика кроссовок",
    Shoes: "Кроссовки",
